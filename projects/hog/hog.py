...
def free_bacon(score):
    ...
    for i in range(1,7):
        alternating_dif = alternating_dif + (-1)**(i)*(score_cubed%10)
        score_cubed = score_cubed//10
    return 1 + abs(alternating_dif)
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            points0 = take_turn(roll0,score1,dice)
            if abs(prev0-roll0) == 2 and feral_hogs == True:
                score0 += points0 + 3
            else:
                score0 += points0
            prev0 = points0
            ...
            points1 = take_turn(roll1,score0,dice)
            if abs(prev1 - roll1) == 2 and feral_hogs == True:
                score1 += points1 + 3
            else:
                score1 += points1
            prev1 = points1
...
def announce_highest(who, prev_high=0, prev_score=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0,score1):
        if who == 0 and (score0-prev_score) > prev_high:
        ...
        elif who == 1 and (score1-prev_score) > prev_high:
        ...
        elif who == 1: return announce_highest(who, prev_high, score1)
        elif who == 0: return announce_highest(who, prev_high, score0)
    # END PROBLEM 7
    return say
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    averaged_num_rolls = make_averaged(roll_dice,num_samples)
    best_roll = 0
    for i in range(1,11):
        roll = averaged_num_rolls(i,dice)
        if best_roll < roll:
            best_roll = roll
            j = i
    return j
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=6):
    ...
    if is_swap(score + free_bacon(opponent_score), opponent_score) == True:
        if score + free_bacon(opponent_score) < opponent_score: return 0
        else: return num_rolls
    elif free_bacon(opponent_score) >= margin: return 0
    else: return num_rolls
    # END PROBLEM 11
